defmodule SoundboardWeb.AudioPlayer do
  ...
  defp play_sound_task(guild_id, channel_id, sound_name, path_or_url, username) do
    ...
    if ensure_voice_ready(guild_id, channel_id) do
      play_sound_with_connection(guild_id, channel_id, sound_name, path_or_url, username)
    else
  ...
  defp play_sound_with_connection(guild_id, _channel_id, sound_name, path_or_url, username) do
  ...
  defp prepare_play_input(sound_name, path_or_url) do
    ...
    case sound do
      ...
      %{source_type: "local"} ->
        ...
        # ffmpeg doesn't accept file:// URLs, it needs raw paths
